 ...
 */
//@Component
public class HttpOAClientUtil {
    private static int seq = 0;

    private static Logger logger = LoggerFactory.getLogger(HttpOAClientUtil.class);
...
//    			headerMap.put("cache-control", "no-cache");
        ...
        //测试
        String url = "http://66.2.43.83/api/v2/jsb/webservice/CreateFlowGtasksService?wsdl";
        //生产
        //String url = "http://88.1.48.184/api/v2/jsb/webservice/CreateFlowGtasksService?wsdl";
        ...
        try {
            ...
            if (url.startsWith("https")) {
                ...
                // 执行 Http 请求.
                client = HttpOAClientUtil.client;
                res = client.execute(post);
            }
...
//			    logger.info("Error-Code为:"+ErrorCode);
        ...
        System.out.println("返回码结果：" + result);
        return result;
    }
    ...
    public static String getSoapStr(List<String> userIdList, String orderNo,String title ,String value,String position) {
        ...
        sb.append("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:pus=\"http://www.jscb.com.cn/mxmop/type/CreateFlowGtasksService/\">\n");
        sb.append("<soapenv:Header/>");
        sb.append("<soapenv:Body>");
        sb.append("<pus:createFlowGtasks>");
        sb.append("<arg0>");
        sb.append("<SEQ_NO>");
        sb.append(seqNo);
        sb.append("</SEQ_NO>");
        ...
        sb.append("</SOURCE>");
        sb.append("<TYPE>");
        sb.append("LC_ZSYW_001");
        sb.append("</TYPE>");
        sb.append("<OWNER_LIST>");
        sb.append("<OWNER>");
        sb.append("<OWNER_ID>");
        sb.append(join);
        sb.append("</OWNER_ID>");
        ...
        sb.append("</ITEM>");
        sb.append("</FORM_ITEM_LIST>");
        sb.append("<CANDIDATE_USER_LIST>");
        sb.append("<CANDIDATE_USER>");
        sb.append("<USER_ID/>");
        sb.append("<USER_TYPE/>");
        sb.append("</CANDIDATE_USER>");
        sb.append("</CANDIDATE_USER_LIST>");
        ...
        logger.info("发送内容数据：" + sb.toString());
        return  sb.toString();
    }
