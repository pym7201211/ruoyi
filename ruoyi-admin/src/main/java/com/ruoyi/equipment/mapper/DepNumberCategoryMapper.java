...
public interface DepNumberCategoryMapper 
{
     ...
     * @return 结果
     */
    public Map<String,Object> getNextIdentity(String id);
     ...
     * @return
     */
    public int insertCategory(@Param("identity") String identity,@Param("brand") String brand,@Param("parentId") String parentId);
     ...
     * @return
     */
    public int deleteFeedback(@Param("seqNo") String seqNo);
